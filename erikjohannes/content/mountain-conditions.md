...
<nav id="fixedMenu">
    <h3>Areas:</h3>
    <ul>
        <li><a href="#Dovrefjell">Dovrefjell</a></li>
        <li><a href="#Folldal">Folldal</a></li>
        <li><a href="#Jotunheimen-Sognefjellet">Jotunheimen - Sognefjellet</a></li>
        <li><a href="#Jotunheimen-Valdresflye">Jotunheimen - Valdresflye</a></li>
        <li><a href="#Meråker">Meråker</a></li>
        <li><a href="#Oslo">Oslo</a></li>
        <li><a href="#Romsdal">Romsdal</a></li>
        <li><a href="#Rondane">Rondane</a></li>
        <li><a href="#Sunndalsøra">Sunndalsøra</a></li>
        <li><a href="#Sylan">Sylan</a></li>
        <li><a href="#Todalen">Todalen</a></li>
        <li><a href="#Trollheimen">Trollheimen</a></li>
...
<section>
    ...
    <p><a href="https://www.adressa.no/kamera/">Link to overview over several other webcams in the Trondheim/Trøndelag area.</a></p>
    <hr>
